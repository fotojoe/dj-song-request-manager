...
function dj_srm_create_tables() {
    ...
    // === EVENTS ===
    $sql_events = "CREATE TABLE {$prefix}dj_srm_events (
    ...
    // === REQUESTS ===
    $sql_requests = "CREATE TABLE {$prefix}dj_srm_requests (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    // === POLLS ===
    $sql_polls = "CREATE TABLE {$prefix}dj_srm_polls (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
        event_id BIGINT(20) UNSIGNED,
    ...
    // === POLL VOTES ===
    $sql_votes = "CREATE TABLE {$prefix}dj_srm_poll_votes (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    // === AWARDS ===
    $sql_awards = "CREATE TABLE {$prefix}dj_srm_awards (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
        event_id BIGINT(20) UNSIGNED,
        name VARCHAR(255) NOT NULL,
    ...
    // === OFFERS ===
    $sql_offers = "CREATE TABLE {$prefix}dj_srm_offers (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    // === GUESTBOOK ===
    $sql_guestbook = "CREATE TABLE {$prefix}dj_srm_guestbook (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
        event_id BIGINT(20) UNSIGNED,
        name VARCHAR(255) NOT NULL,
    ...
    // === AFTERPARTY ===
    $sql_afterparty = "CREATE TABLE {$prefix}dj_srm_afterparty (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
        event_id BIGINT(20) UNSIGNED,
        playlist LONGTEXT,
        highlights TEXT,
    ...
    // === SETTINGS ===
    $sql_settings = "CREATE TABLE {$prefix}dj_srm_settings (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    // === LOGS ===
    $sql_logs = "CREATE TABLE {$prefix}dj_srm_logs (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    // === IP BLOCKLIST ===
    $sql_block = "CREATE TABLE {$prefix}dj_srm_ip_blocklist (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    // === OBS SETTINGS ===
    $sql_obs = "CREATE TABLE {$prefix}dj_srm_obs_settings (
        id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
        option_name VARCHAR(191) NOT NULL,
        value TEXT,
        PRIMARY KEY (id),
